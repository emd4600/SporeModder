...
public class SPUIStructResource extends SPUIDefaultObject implements SPUIResource {
	...
	public String getString() {
		return "StructResource " + Hasher.getName(hash, MainApp.getRegistry(NameRegistry.NAME_SPUI));
	}
	
	@Override
	public void parse(String str) throws IOException {
		// hash
		hash = Hasher.getHash(str.trim(), MainApp.getRegistry(NameRegistry.NAME_SPUI));
	}
	...
	public String getHashString() {
		return Hasher.getName(hash, MainApp.getRegistry(NameRegistry.NAME_SPUI));
	}
	...
	public void parse(ArgScriptCommand c) throws ArgScriptException,
		...
		Hasher.getHash(c.getLastArgument(), MainApp.getRegistry(NameRegistry.NAME_SPUI));
	}
